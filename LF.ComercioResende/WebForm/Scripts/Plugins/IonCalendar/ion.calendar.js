    ...
    var methods = {
        init: function (options) {
            ...
            return this.each(function () {
                ...
                var prepareCalendar = function (remove) {
                    ...
                    html = '<div class="ic__container" id="ic__container">';
                    ...
                    placeCalendar(remove);
                };

                var placeCalendar = function (remove) {
                    $calendar.html(html);
                    ...
                    if (settings.idFullCalendar != null) {
                        $("#" + settings.idFullCalendar).fullCalendar('gotoDate', timeNowLocal.format(settings.format));
